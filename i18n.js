(() => {
  ...
  const translations = {
    en: english,
      ...
      approach: 'Sopeudun helposti uusiin tehtäviin ja teknologioihin, selvitän mielelläni, miten asiat toimivat, ja kehitän ideoista käytännöllisiä ratkaisuja.',
    ...
    ru: {
      ...
      approach: 'Легко адаптируюсь к новым задачам и технологиям, люблю разбираться в том, как всё устроено, и превращать идеи в полезные решения.',

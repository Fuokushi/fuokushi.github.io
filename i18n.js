(() => {
  ...
  const translations = {
    en: english,
      ...
      skip: 'Siirry sisältöön', navigation: 'Päänavigaatio', navWork: 'Projektit', navAbout: 'Minusta', navContact: 'Yhteys ↗', language: 'Kieli',
      portrait: 'Lev Yarysh järven ja vuorten edustalla', hero: 'Web-kehittäjä.<br>Python &amp;<br>JavaScript.', heroNote: 'Python · JavaScript · SQL', scroll: 'Vieritä alas <span>↓</span>',
      ...
      contactLabel: 'YHTEYS', contactNote: 'Sähköposti', contactHeading: 'Ota<span> yhteyttä.</span><span class="contact-arrow" aria-hidden="true">↗</span>', contactInvite: 'Projektit, työ- ja harjoittelumahdollisuudet.', copyright: '© 2026 · Henkilökohtainen portfolio', backTop: 'Takaisin ylös ↑',
      description: 'Lev Yarysh — web-kehittäjä Joensuusta. Python, JavaScript, Flask ja Odoo. Projektit ja yhteystiedot.'
    },
    ru: {
      skip: 'Перейти к содержимому', navigation: 'Основная навигация', navWork: 'Работы', navAbout: 'Обо мне', navContact: 'Контакт ↗', language: 'Язык',
      portrait: 'Lev Yarysh на фоне гор и озера', hero: 'Веб-разработчик.<br>Python &amp;<br>JavaScript.', heroNote: 'Python · JavaScript · SQL', scroll: 'Листай ниже <span>↓</span>',
      ...
      contactLabel: 'КОНТАКТ', contactNote: 'Почта', contactHeading: 'Связаться<br><span>со мной.</span><span class="contact-arrow" aria-hidden="true">↗</span>', contactInvite: 'По вопросам проектов, работы и практики.', copyright: '© 2026 · Персональное портфолио', backTop: 'Наверх ↑',
